...
class PersonController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return ApiResponse::success('People fetched successfully');
    }

    public function create()
    {
        return ApiResponse::success('Create person form data');
    }

    public function store(StorePersonRequest $request)
    {
        $person = $this->personService->store($request);
        return ApiResponse::success('Person created successfully', 201);
    }

    public function show($id)
    {
        $person = $this->personService->getPerson($id);
        return ApiResponse::success('Person fetched successfully');
    }
